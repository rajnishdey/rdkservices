...
public:
    ...
    MOCK_METHOD(std::string, getEDIDBytesInfo, (int iHdmiPort, std::vector<uint8_t> &edid), (const, override));
    ...
    MOCK_METHOD(std::string, getSupportedGameFeatures, (std::vector<std::string> &featureList), (const, override)); 
};
