...
public:
    ...
    MOCK_METHOD(std::vector<uint8_t>, getEDIDBytesInfo, (int iHdmiPort, std::vector<uint8_t> &edid), (const, override));
    MOCK_METHOD(std::vector<uint8_t>, getHDMISPDInfo, (int iHdmiPort, std::vector<uint8_t> &data), (const, override));
    MOCK_METHOD(void, setEdidVersion, (int iHdmiPort, int iEdidVersion), (const, override));
    MOCK_METHOD(int, getEdidVersion, (int iHdmiPort, int *iEdidVersion), (const, override));
    MOCK_METHOD(bool, getHdmiALLMStatus, (int iHdmiPort, bool *allmStatus), (const, override));
    MOCK_METHOD(std::vector<std::string>, getSupportedGameFeatures, (std::vector<std::string> &featureList), (const, override)); 
};
